...
return [
    ...
    */
    ...
    "between" => [
        ...
        "string" =>
            "El campo :attribute debe estar entre :min y :max caracteres.",
        "array" =>
    ...
    "declined_if" =>
        "El campo :attribute debe rechazarse cuando :other es :value.",
    "different" => "El campo :attribute y :other deben ser diferentes.",
    "digits" => "El campo :attribute debe ser :digits dígitos.",
    "digits_between" =>
        "El campo :attribute debe estar entre :min y :max dígitos.",
    "dimensions" =>
    ...
    "gt" => [
        ...
        "file" => "El campo :attribute debe ser mayor que :value en kilobytes.",
    ...
    "gte" => [
        ...
        "file" =>
            "El campo :attribute debe ser mayor o igual que :value en kilobytes.",
        "string" =>
            "El campo :attribute debe ser mayor o igual que :value caracteres.",
    ...
    "lte" => [
        ...
        "file" =>
            "El campo :attribute debe ser menor o igual que :value en kilobytes.",
        "string" =>
            "El campo :attribute debe ser menor o igual que :value caracteres.",
    ...
    "prohibited_unless" =>
        "El campo :attribute está prohibido a menos que :other esté en :value.",
    ...
    "required_if" =>
        "El campo :attribute es obligatorio cuando :other es :values.",
    "required_unless" =>
    ...
    "size" => [
        ...
        "file" => "El campo :attribute debe ser :size en kilobytes.",
