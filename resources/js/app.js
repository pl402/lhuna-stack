        ...
        app.mixin({
            mounted() {
                if (this.$page && this.$page.props) {
                    this.$watch(
                        () => this.$page.props.themeColor,
                        (newColor) => {
                            if (newColor && newColor !== currentThemeColor && colors[newColor]) {
                                currentThemeColor = newColor;
                                const selectedColor = colors[newColor];
                                const root = document.documentElement;
                                Object.keys(selectedColor).forEach(key => {
