...
<template>
  <div>
    <div class="p-6 sm:px-20 bg-dark-surface border-b border-dark-border">
      <div>
    ...
    <div class="bg-dark-elevated/80 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
      <div class="p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4 text-lg text-slate-400 leading-7 font-semibold">
      ...
      <div class="p-6 border-t border-dark-border md:border-t-0 md:border-l">
        <div class="flex items-center">
          <svg
            fill="none"
            stroke="currentColor"
      ...
      <div class="p-6 border-t border-dark-border md:border-l">
        <div class="flex items-center">
          <svg
            fill="none"
            stroke="currentColor"
