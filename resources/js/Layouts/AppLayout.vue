...
<template>
    <div>
        ...
        <div class="min-h-screen bg-slate-100">
                                ...
                                >
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-slate-500 bg-white hover:bg-slate-50 hover:text-slate-700 focus:outline-none focus:bg-slate-50 active:bg-slate-50 transition"
                                            >
                                                {{
                                                    $page.props.user
                                                        .current_team.name
                                ...
                                <JetDropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        >
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-slate-500 bg-white hover:text-slate-700 focus:outline-none transition"
                                            >
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-slate-200">
                        <div class="flex items-center px-4">
                            ...
                            <div>
                                <div
                                    class="font-medium text-base text-slate-800"
                                >
                                    {{ $page.props.user.name }}
                                </div>
            ...
            <!-- Page Footer -->
            <footer
                class="bg-slate-200/80 shadow-2xl fixed bottom-0 w-screen border-t border-slate-100"
            >
                <div class="max-w-7xl mx-auto py-1 px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <div>
                            <a href="https://lhuna.dev" target="_blank"
                                >© lhuna.dev - 2022</a
                            >
                        </div>
                        <div>Sistema PDI</div>
