    ...
    <JetActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                ...
                puede no ser exhaustiva. Si cree que su cuenta ha sido
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                >
                                <span v-else
                                    >Activo {{ session.last_active }}</span
                                >
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex items-center mt-5">
                <JetButton @click="confirmLogout">
                    Cerrar sesiones de otros navegadores
                </JetButton>
            ...
            <JetDialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    de sus otros navegadores de todos sus dispositivos.
